...
def lists():
    ...
    c = [r[i][2] for i in (0,1,2)]
    # Collect only the even items of the diagonal of matrix A using list comprehension
    d=[r[i][i]for i in (0,1,2) if (r[i][i]%2==0)]
...
def dictionaries():
    ...
    f={"name":{"first_name":"Grace", "last_name":"Hopper"},"job":["scientist", "engineer"], "age":85}

    # Add "programmer" to the list of jobs Grace has
    # IMPLEMENT IT HERE
    f["job"].append('programmer')
